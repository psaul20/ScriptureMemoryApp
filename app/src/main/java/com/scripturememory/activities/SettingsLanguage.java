...
public class SettingsLanguage extends AppCompatActivity implements OnLanguageSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.settings_language_fragment);

        if (findViewById(R.id.settings_language_fragment_container) != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.settings_language_fragment_container, languageFragment)
                    .commit();
